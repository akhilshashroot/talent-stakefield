        ...
        <div class="page-wrapper">
            ...
            <main>
                ...
                <div class="content-wrapper">
                    ...
                    <!-- <section class="content-block quotation-block black-overlay-1 parallax" data-stellar-background-ratio="0.55"
                    style="background-image: url('./img/case-study/04.jpg'); object-fit:cover;" 
                    >
                        <div class="container">
                    ...
                    <div class="colored-bg fullscreen-bg dark-overlay parallax" data-stellar-background-ratio="0.55" style="background-image: url('./img/privacy-service/3. AUP.jpg');">
                        <div class="centered centered-wrap text-center">
                            <div class="container">
                                <div class="visual-text visual-center">                              
                                    <h1 class="visual-title visual-sub-title">SOURCING THE BEST TALENTS FOR YOU </h1>
                              <p>
                              Helping you find the right professionals for your organization!</p>
