          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> Add Employee</button>
              </div>
              <!-- /.card-header -->
              <div class="card">
              <!-- /.card-header -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form name="employee_add" method="post" action="{{route('employee.store')}}">
                  @csrf
                <div class="card-body">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder="Select a skill" style="width: 100%;">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">Turnaround Time</label>
                    <input type="text" class="form-control" id="time" name="time" placeholder="Enter Turnaround Time">
                </div>
                <div class="form-group">
